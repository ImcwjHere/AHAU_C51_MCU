...
;------------------------------------------------------------
;	.\src\screens\alartScreen.c:4: void alartScreen(unsigned char text[]) {
;	-----------------------------------------
...
_alartScreen:
	...
	mov	r6,dph
	mov	r7,b
;	.\src\screens\alartScreen.c:7: clearLineInLCD1602(0);
	mov	dpl,#0x00
	push	ar7
	push	ar6
	push	ar5
	lcall	_clearLineInLCD1602
;	.\src\screens\alartScreen.c:8: clearLineInLCD1602(1);
	mov	dpl,#0x01
	lcall	_clearLineInLCD1602
	pop	ar5
	pop	ar6
	pop	ar7
;	.\src\screens\alartScreen.c:12: putStringOnLCD1602(0, cur, text);
...
;	.\src\screens\alartScreen.c:13: delayOneMillisecond(300);
	mov	dptr,#0x012c
;	.\src\screens\alartScreen.c:14: }
