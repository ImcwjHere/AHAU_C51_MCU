...
;------------------------------------------------------------
;	.\src\screens\mainScreen.c:4: void mainScreen() {
;	-----------------------------------------
;	 function mainScreen
;	-----------------------------------------
_mainScreen:
	...
	ar1 = 0x01
	ar0 = 0x00
;	.\src\screens\mainScreen.c:8: prepareReadTemperature(readAT24C02(0x00), onScreenHighestTemperature, &highestTemperature);
	mov	dpl,#0x00
	lcall	_readAT24C02
...
;	.\src\screens\mainScreen.c:9: prepareReadTemperature(readAT24C02(0x01), onScreenLowestTemperature, &lowestTemperature);
	mov	dpl,#0x01
	lcall	_readAT24C02
	...
	mov	(_prepareReadTemperature_PARM_3 + 2),#0x40
	lcall	_prepareReadTemperature
;	.\src\screens\mainScreen.c:11: getTemperatureOfDS18B20(onScreenCurrentTemperature, &currentTemperature);
...
;	.\src\screens\mainScreen.c:13: *onScreenFanLevel = (unsigned char)('0' + fanLevel);
	...
	add	a,r7
	movx	@dptr,a
;	.\src\screens\mainScreen.c:16: LED = !(currentTemperature < lowestTemperature);
	...
	add	a,#0xff
	mov	_P20,c
;	.\src\screens\mainScreen.c:20: temp = currentTemperature - highestTemperature;
	...
	mov	r6,dpl
	mov	r7,dph
;	.\src\screens\mainScreen.c:21: if (temp >= 6) {
	clr	c
	mov	a,r6
	subb	a,#0x06
	mov	a,r7
	...
	subb	a,#0x80
	jc	00108$
;	.\src\screens\mainScreen.c:22: fanLevel = 3;
	mov	_fanLevel,#0x03
;	.\src\screens\mainScreen.c:23: fanState[0] = 1;
	mov	_fanState,#0x01
;	.\src\screens\mainScreen.c:24: fanState[1] = 1;
	mov	(_fanState + 0x0001),#0x01
;	.\src\screens\mainScreen.c:25: fanState[2] = 1;
	mov	(_fanState + 0x0002),#0x01
;	.\src\screens\mainScreen.c:26: fanState[3] = 1;
	mov	(_fanState + 0x0003),#0x01
	sjmp	00109$
00108$:
;	.\src\screens\mainScreen.c:27: } else if (temp >= 4) {
	clr	c
	mov	a,r6
	subb	a,#0x04
	mov	a,r7
	...
	subb	a,#0x80
	jc	00105$
;	.\src\screens\mainScreen.c:28: fanLevel = 2;
	mov	_fanLevel,#0x02
;	.\src\screens\mainScreen.c:29: fanState[0] = 1;
	mov	_fanState,#0x01
;	.\src\screens\mainScreen.c:30: fanState[1] = 1;
	mov	(_fanState + 0x0001),#0x01
;	.\src\screens\mainScreen.c:31: fanState[2] = 1;
	mov	(_fanState + 0x0002),#0x01
;	.\src\screens\mainScreen.c:32: fanState[3] = 0;
	mov	(_fanState + 0x0003),#0x00
	sjmp	00109$
00105$:
;	.\src\screens\mainScreen.c:33: } else if (temp >= 2) {
	clr	c
	mov	a,r6
	subb	a,#0x02
	mov	a,r7
	...
	subb	a,#0x80
	jc	00102$
;	.\src\screens\mainScreen.c:34: fanLevel = 1;
	mov	_fanLevel,#0x01
;	.\src\screens\mainScreen.c:35: fanState[0] = 1;
	mov	_fanState,#0x01
;	.\src\screens\mainScreen.c:36: fanState[1] = 1;
	mov	(_fanState + 0x0001),#0x01
;	.\src\screens\mainScreen.c:37: fanState[2] = 0;
	mov	(_fanState + 0x0002),#0x00
;	.\src\screens\mainScreen.c:38: fanState[3] = 0;
	mov	(_fanState + 0x0003),#0x00
	sjmp	00109$
00102$:
;	.\src\screens\mainScreen.c:40: fanLevel = 0;
	mov	_fanLevel,#0x00
;	.\src\screens\mainScreen.c:41: fanState[0] = 0;
	mov	_fanState,#0x00
;	.\src\screens\mainScreen.c:42: fanState[1] = 0;
	mov	(_fanState + 0x0001),#0x00
;	.\src\screens\mainScreen.c:43: fanState[2] = 0;
	mov	(_fanState + 0x0002),#0x00
;	.\src\screens\mainScreen.c:44: fanState[3] = 0;
	mov	(_fanState + 0x0003),#0x00
00109$:
;	.\src\screens\mainScreen.c:48: putStringOnLCD1602(0, 0, firstLine);
...
;	.\src\screens\mainScreen.c:49: putStringOnLCD1602(1, 0, secondLine);
	mov	_putStringOnLCD1602_PARM_3,#_secondLine
	mov	(_putStringOnLCD1602_PARM_3 + 1),#(_secondLine >> 8)
	mov	(_putStringOnLCD1602_PARM_3 + 2),#0x00
	mov	_putStringOnLCD1602_PARM_2,#0x00
	mov	dpl,#0x01
;	.\src\screens\mainScreen.c:50: }
