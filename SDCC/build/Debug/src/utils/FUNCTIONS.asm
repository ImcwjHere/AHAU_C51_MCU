...
;------------------------------------------------------------
;	.\src\utils\FUNCTIONS.c:7: void prepareReadTemperature(unsigned char temperature, unsigned char *buf, int *globalVariable) {
;	-----------------------------------------
...
_prepareReadTemperature:
	...
	ar0 = 0x00
	mov	r7,dpl
;	.\src\utils\FUNCTIONS.c:9: if (temperature >= 129) {
	cjne	r7,#0x81,00132$
00132$:
	jnc	00133$
	ljmp	00102$
00133$:
;	.\src\utils\FUNCTIONS.c:11: temperature = 255 - temperature + 1;
	mov	ar6,r7
	clr	c
	clr	a
	subb	a,r6
	mov	r6,a
;	.\src\utils\FUNCTIONS.c:12: buf[0] = '-';    // 负号
	...
	mov	a,#0x2d
	lcall	__gptrput
;	.\src\utils\FUNCTIONS.c:13: buf[1] = (unsigned char)(temperature % 100 / 10 + '0');
	mov	a,#0x01
	add	a,r3
...
;	1-genFromRTrack replaced	mov	(__modsint_PARM_2 + 1),#0x00
	...
	lcall	__gptrput
;	.\src\utils\FUNCTIONS.c:14: buf[2] = (unsigned char)(temperature % 10 + '0');
	mov	a,#0x02
	add	a,r3
	mov	r3,a
	clr	a
	...
	mov	b,r5
	lcall	__gptrput
;	.\src\utils\FUNCTIONS.c:16: *globalVariable = (int)(-1 * ((int)(buf[1] - '0') * 10 + (int)(buf[2] - '0')));
	...
	ljmp	00103$
00102$:
;	.\src\utils\FUNCTIONS.c:20: buf[0] = (unsigned char)(temperature / 100 + '0');
...
;	1-genFromRTrack replaced	mov	(__divsint_PARM_2 + 1),#0x00
	...
	lcall	__gptrput
;	.\src\utils\FUNCTIONS.c:21: buf[1] = (unsigned char)(temperature % 100 / 10 + '0');   
	mov	a,#0x01
	add	a,r4
	...
	lcall	__gptrput
;	.\src\utils\FUNCTIONS.c:22: buf[2] = (unsigned char)(temperature % 10 + '0'); 
	mov	a,#0x02
	add	a,r4
	mov	r4,a
	clr	a
	...
	mov	b,r6
	lcall	__gptrput
;	.\src\utils\FUNCTIONS.c:24: *globalVariable = (int)((int)(buf[0] - '0') * 100 + (int)(buf[1] - '0') * 10 + (int)(buf[2] - '0'));
	...
	lcall	__gptrput
00103$:
;	.\src\utils\FUNCTIONS.c:27: if (buf[0] == '0') buf[0] = ' ';
	...
	lcall	__gptrput
00105$:
;	.\src\utils\FUNCTIONS.c:29: if (buf[1] == '0' && (buf[0] == ' '||buf[0] == '-')) {
	mov	a,#0x01
	add	a,r5
	mov	r2,a
	clr	a
...
00138$:
	...
	cjne	r1,#0x2d,00110$
00106$:
;	.\src\utils\FUNCTIONS.c:30: buf[1] = buf[0];
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	lcall	__gptrget
	...
	mov	b,r4
	lcall	__gptrput
;	.\src\utils\FUNCTIONS.c:31: buf[0] = ' ';
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	mov	a,#0x20
;	.\src\utils\FUNCTIONS.c:33: }
	ljmp	__gptrput
00110$:
	ret
;------------------------------------------------------------
...
;num                       Allocated with name '_floatToText_num_65536_9'
;------------------------------------------------------------
;	.\src\utils\FUNCTIONS.c:36: void floatToText(int num, unsigned char *buf) {
;	-----------------------------------------
;	 function floatToText
;	-----------------------------------------
_floatToText:
	mov	_floatToText_num_65536_9,dpl
;	.\src\utils\FUNCTIONS.c:38: if (num < 0) {
	mov	a,dph
	mov	(_floatToText_num_65536_9 + 1),a
	jb	acc.7,00128$
	ljmp	00102$
00128$:
;	.\src\utils\FUNCTIONS.c:39: buf[0] = '-';
	...
	mov	a,#0x2d
	lcall	__gptrput
;	.\src\utils\FUNCTIONS.c:40: buf[1] = (unsigned char)(-1 * (int)(num / 10) + '0');
	mov	a,#0x01
	add	a,r3
	mov	r0,a
	clr	a
	...
	mov	__divsint_PARM_2,#0x0a
	mov	(__divsint_PARM_2 + 1),#0x00
	mov	dpl,_floatToText_num_65536_9
	mov	dph,(_floatToText_num_65536_9 + 1)
	push	ar5
	push	ar4
	push	ar3
	push	ar2
	...
	mov	b,r2
	lcall	__gptrput
;	.\src\utils\FUNCTIONS.c:41: buf[2] = (unsigned char)(-1 * (int)(num % 10) + '0');
	mov	a,#0x02
	add	a,r3
	mov	r3,a
	clr	a
	...
	ljmp	00103$
00102$:
;	.\src\utils\FUNCTIONS.c:43: buf[0] = (unsigned char)(num / 100 + '0');
	...
	mov	b,r7
	lcall	__gptrput
;	.\src\utils\FUNCTIONS.c:44: buf[1] = (unsigned char)(num % 100 / 10 + '0');
	mov	a,#0x01
	add	a,r5
	mov	r2,a
	clr	a
	...
	mov	b,r4
	lcall	__gptrput
;	.\src\utils\FUNCTIONS.c:45: buf[2] = (unsigned char)(num % 10 + '0');
	mov	a,#0x02
	add	a,r5
	mov	r5,a
	clr	a
	...
	lcall	__gptrput
00103$:
;	.\src\utils\FUNCTIONS.c:48: if (buf[0] == '0') buf[0] = ' ';
	mov	r5,_floatToText_PARM_2
	mov	r6,(_floatToText_PARM_2 + 1)
	mov	r7,(_floatToText_PARM_2 + 2)
	mov	dpl,r5
	...
	lcall	__gptrput
00105$:
;	.\src\utils\FUNCTIONS.c:50: if (buf[1] == '0' && (buf[0] == ' '||buf[0] == '-')) {
	mov	a,#0x01
	add	a,r5
	mov	r2,a
	clr	a
...
00133$:
	...
	cjne	r1,#0x2d,00110$
00106$:
;	.\src\utils\FUNCTIONS.c:51: buf[1] = buf[0];
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	lcall	__gptrget
	...
	mov	b,r4
	lcall	__gptrput
;	.\src\utils\FUNCTIONS.c:52: buf[0] = ' ';
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	mov	a,#0x20
;	.\src\utils\FUNCTIONS.c:54: }
	ljmp	__gptrput
00110$:
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	.\src\utils\FUNCTIONS.c:56: void initializeEverything() {
;	-----------------------------------------
;	 function initializeEverything
;	-----------------------------------------
_initializeEverything:
;	.\src\utils\FUNCTIONS.c:58: BEEP=1;
;	assignBit
	setb	_P14
;	.\src\utils\FUNCTIONS.c:59: FAN=0;
;	assignBit
	clr	_P27
;	.\src\utils\FUNCTIONS.c:60: LED=1;
;	assignBit
	setb	_P20
;	.\src\utils\FUNCTIONS.c:62: initializeFan();    // 初始化风扇
	lcall	_initializeFan
;	.\src\utils\FUNCTIONS.c:63: initializeLCD1602();    // 初始化LCD1602
	lcall	_initializeLCD1602
;	.\src\utils\FUNCTIONS.c:64: initializeDS18B20();    // 初始化DS18B20，返回1表示初始化成功，返回0表示初始化失败，这里不做处理
;	.\src\utils\FUNCTIONS.c:65: }
