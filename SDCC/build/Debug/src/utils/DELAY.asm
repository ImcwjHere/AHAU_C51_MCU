...
;------------------------------------------------------------
;	.\src\utils\DELAY.c:6: void delayOneMillisecond(unsigned int n) {
;	-----------------------------------------
...
_delayOneMillisecond:
	...
	mov	r7,dph
00107$:
;	.\src\utils\DELAY.c:8: for(;n > 0;n --) for(i = 0;i < 123;i ++);
	mov	a,r6
	orl	a,r7
	jz	00109$
	mov	r4,#0x7b
...
;n                         Allocated to registers 
;------------------------------------------------------------
;	.\src\utils\DELAY.c:12: void delayOneSecond(unsigned int n) {
;	-----------------------------------------
...
_delayOneSecond:
	...
	mov	r7,dph
00103$:
;	.\src\utils\DELAY.c:13: for(;n > 0;n --) delayOneMillisecond(1000);
	mov	a,r6
	orl	a,r7
	jz	00105$
	mov	dptr,#0x03e8
...
;n                         Allocated to registers 
;------------------------------------------------------------
;	.\src\utils\DELAY.c:17: void delayTenMicroseconds(unsigned int n) {
;	-----------------------------------------
