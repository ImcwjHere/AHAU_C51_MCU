...
;--------------------------------------------------------
	.area DSEG    (DATA)
_settingScreen_blankspaceText_65537_20:
	.ds 4
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BSEG    (BIT)
_settingScreen_currentCursor_65537_20:
	.ds 1
_settingScreen_prevCursor_65537_20:
	.ds 1
_settingScreen_splashState_65537_20:
	.ds 1
...
;------------------------------------------------------------
;blankspaceText            Allocated with name '_settingScreen_blankspaceText_65537_20'
;------------------------------------------------------------
...
;	assignBit
	clr	_settingScreen_currentCursor_65537_20
;	assignBit
	clr	_settingScreen_prevCursor_65537_20
;	.\src\screen\settingScreen.c:29: bit splashState=0;  // 闪烁光标状态，0表示显示温度，1表示显示空格
;	assignBit
	clr	_settingScreen_splashState_65537_20
;	.\src\screen\settingScreen.c:30: unsigned char blankspaceText[] = "   ";    // 空格
	mov	_settingScreen_blankspaceText_65537_20,#0x20
	mov	(_settingScreen_blankspaceText_65537_20 + 0x0001),#0x20
	mov	(_settingScreen_blankspaceText_65537_20 + 0x0002),#0x20
	mov	(_settingScreen_blankspaceText_65537_20 + 0x0003),#0x00
...
;	.\src\screen\settingScreen.c:36: if (currentCursor != prevCursor) {
	mov	c,_settingScreen_currentCursor_65537_20
	jb	_settingScreen_prevCursor_65537_20,00241$
	cpl	c
00241$:
	jc	00105$
...
;	assignBit
	mov	c,_settingScreen_currentCursor_65537_20
	mov	_settingScreen_prevCursor_65537_20,c
00105$:
...
;	assignBit
	...
	dec	a
	add	a,#0xff
	mov	_settingScreen_splashState_65537_20,c
	jnb	_settingScreen_sloc0_1_0,00147$
	mov	_putStringOnLCD1602_PARM_3,#_settingScreen_blankspaceText_65537_20
